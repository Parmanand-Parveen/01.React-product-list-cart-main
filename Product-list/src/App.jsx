  ...
  return (
    <>
      <div className="flex flex-col lg:flex-row bg-rose-100">
        ...
        <div className="h-full rounded-lg w-[284px] mx-auto mb-3 lg:mt-5 p-3 flex flex-col gap-2 bg-white">
         <p className="text-lg text-orange-500 font-bold">Your Cart</p> 
         ...
         <p className="text-[#ad8a85]">Your item will appear hear</p>
        </div>
      </div>
    </>
  );
